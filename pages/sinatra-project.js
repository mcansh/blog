  ...
  return (
    <Document>
      <Head>
        ...
        <meta name="og:image" content={`/static/images/${image}`} />
      </Head>
      <Header text={title} image={image} date="April 15, 2017" />
      <PostContainer>
        <Progress />

        <P>Long time no see! It’s time to talk about my <Link href="https://github.com/mcansh/sinatra-project" rel="external noopener"><a>sinatra portfolio project</a></Link> for Learn.co! I’m not exactly sure what I need to talk about, so maybe just a quick run through..</P>
