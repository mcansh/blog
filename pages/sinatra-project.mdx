...
export default ({children}) => <Post id="sinatra-project">{children}</Post>

Long time no see! It’s time to talk about my <a href="https://github.com/mcansh/sinatra-project" target="_blank" rel="noopener external nofollow">sinatra portfolio project</a> for <a href="https://learn.co" target="_blank" rel="noopener external nofollow">Learn.co</a>! I’m not exactly sure what I need to talk about, so maybe just a quick run through..
