...
const Index = () => (
  <Layout>
    ...
    <PostContainer>
      ...
      <P>Yeah, I know, another short post *sigh*. Who knows maybe I’ll keep this blogging thing up and going and get better. *gasp* The same process can be made with coding and blogging 😱.</P>
      <style jsx>{`
        a {
          color: #E53A40;
